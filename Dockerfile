FROM openjdk:8-jdk
WORKDIR /opt/java
RUN wget --user=admin --password=admin123 http://49.37.155.202:8081/repository/maven-releases/es/macero/dev/spring-boot-restcontroller-example/3.3.3/spring-boot-restcontroller-example-3.3.3-debug.jar
