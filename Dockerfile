FROM openjdk:8-jdk
WORKDIR /opt/java
RUN wget --user=admin --password=nexus123 http://aa5e-49-37-154-89.ngrok.io/repository/maven-releases/es/macero/dev/spring-boot-restcontroller-example/3.3.3/spring-boot-restcontroller-example-3.3.3-debug.jar
